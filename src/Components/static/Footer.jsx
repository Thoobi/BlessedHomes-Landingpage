  ...
  return (
    <div className="font-urbanist w-full max-w-screen-2xl mx-auto text-white">
      <div className="w-full bg-[#141414]">
        <div
          className="w-[90%] mx-auto py-[60px] px-[80px] bg-no-repeat bg-cover flex flex-row justify-between items-center max-lg:flex-col max-lg:w-full max-lg:px-4 max-lg:py-[50px] max-lg:gap-[30px]"
        ...
        >
          <div className="w-[70%] max-lg:w-full">
            ...
            <p className="text-base font-medium max-lg:text-sm text-[#999999]">
              ...
              estate advice, Ten Times Better Blessed Homes and Properties is
              here to assist you every step of the way. Take the first step
              towards your real estate goals and explore our available
            ...
            <div className="w-full flex justify-start">
              <img
                ...
                className="h-[50px] w-[180px]
                            max-lg:w-[120px] max-lg:h-[45px] self-start"
                alt="The logo"
              />
            </div>
